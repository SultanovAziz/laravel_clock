                    ...
                    <div class="sngl-top">
                        ...
                        <div class="col-md-7 single-top-right">
                            <div class="single-para simpleCart_shelfItem">
                                ...
                                <h5 class="item_price" id="base-price">@currency_money($product->price,$currency['code'])</h5>
                                @if($product->old_price)
                                <del>@currency_money($product->old_price,$currency['code'])</del>
                                @endif
                                <p>{{ $product->content }}</p>
                                <?php if($mods): ?>
                                <div class="available">
                                        ...
                                        <li>Color
                                            <select>
                                                ...
                                                <option data-title="{{ $mod->title }}"
                                                        data-price="{{ App\Facades\Currency::convertToDefault($mod->price,$currency['code']) }}"                                                                         value="<?=$mod->id;?>">{{ $mod->title }}</option>
                                                <?php endforeach; ?>
                                            </select>
                                        </li>
                                        <div class="clearfix"> </div>
                                ...
                                <ul class="tag-men">
                                    <li><span>Category</span>
                                        <span>: <a href="category/{{ $product->categories->alias }}">{{ $product->categories->title }}</a></span></li>
                                </ul>
                                <div class="quantity">
                                    ...
                                    <div class="product-main simpleCart_shelfItem">
                                        ...
                                        <div class="product-bottom">
                                            ...
                                            <h4>
                                                ...
                                                <span class="item_price">@currency_money($item->price,$currency['code'])</span>
                                                @if($item->old_price)
                                                    <small><del>@currency_money($item->old_price,$currency['code'])</del></small>
                                                @endif
                                            </h4>
                                        </div>
                                        @if($item->old_price)
                                            <div class="srch">
                                                <span>{{'A discount : ' .round((($item->old_price-$item->price)/$item->old_price)*100) }}%</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
